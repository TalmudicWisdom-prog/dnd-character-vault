...
export const spellSchema = z.object({
  ...
  levelKnown: z.boolean().default(true),
  ...
  rulesSourceId: z.string().max(200).default(""),
  contentSourceId: z.string().max(200).default(""),
  sourcePage: z.number().int().min(1).nullable().default(null),
  sourceClass: z.string().max(100).default(""),
  sourceSubclass: z.string().max(100).default(""),
  castingAbilityOverride: abilityIdSchema.nullable().default(null),
  rulesComplete: z.boolean().default(true),
  referenceDefinitionId: z.string().max(200).default(""),
  referenceClasses: z.array(z.string().max(100)).default([]),
  referenceSourcePages: z.array(z.number().int().min(1)).default([]),
  completionReviewed: z.boolean().default(false),
  prepared: z.boolean().default(false),
  alwaysPrepared: z.boolean().default(false),
  imported: z.boolean().default(false),
  importSourceName: z.string().max(300).default(""),
  importSourceIndex: z.number().int().min(0).nullable().default(null),
  importVariantKey: z.string().max(2000).default(""),
...
export const settingsSchema = z.object({
  ...
  enabledContentSourceIds: z.array(z.string().max(200)).default(["ffxiv-companion-dawntrail"]),
