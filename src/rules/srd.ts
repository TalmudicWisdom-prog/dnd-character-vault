...
export const srdEquipment: SrdEquipmentItem[] = [
  ...
  { id: "club", name: "Club", category: "Weapon", description: "A simple melee weapon.", source: srdRulesSource },
  { id: "dagger", name: "Dagger", category: "Weapon", description: "A light simple weapon.", source: srdRulesSource },
  { id: "dart", name: "Dart", category: "Weapon", description: "A simple ranged weapon.", source: srdRulesSource },
  ...
  { id: "greatclub", name: "Greatclub", category: "Weapon", description: "A simple melee weapon.", source: srdRulesSource },
  { id: "handaxe", name: "Handaxe", category: "Weapon", description: "A simple melee weapon.", source: srdRulesSource },
  { id: "javelin", name: "Javelin", category: "Weapon", description: "A simple melee weapon.", source: srdRulesSource },
  { id: "leather-armor", name: "Leather Armor", category: "Armor", description: "Light armor.", source: srdRulesSource },
  { id: "light-crossbow", name: "Light Crossbow", category: "Weapon", description: "A simple ranged weapon.", source: srdRulesSource },
  { id: "light-hammer", name: "Light Hammer", category: "Weapon", description: "A simple melee weapon.", source: srdRulesSource },
  ...
  { id: "martial-weapon", name: "Martial Weapon", category: "Weapon", description: "Choose a specific martial weapon.", placeholder: true, expandsTo: ["battleaxe", "longbow", "longsword", "rapier", "shortsword"], source: srdRulesSource },
  ...
  { id: "sickle", name: "Sickle", category: "Weapon", description: "A simple melee weapon.", source: srdRulesSource },
  { id: "simple-weapon", name: "Simple Weapon", category: "Weapon", description: "Choose a specific simple weapon.", placeholder: true, expandsTo: ["club", "dagger", "handaxe", "javelin", "light-hammer", "mace", "quarterstaff", "sickle", "spear"], source: srdRulesSource },
  { id: "sling", name: "Sling", category: "Weapon", description: "A simple ranged weapon.", source: srdRulesSource },
  { id: "spear", name: "Spear", category: "Weapon", description: "A simple melee weapon.", source: srdRulesSource },
...
export const srdClasses: SrdClass[] = [
  ...
  { name: "Druid", primaryAbilities: ["wis"], complexity: "High", savingThrows: ["int", "wis"], skillChoiceCount: 2, recommendedSkills: ["animalHandling", "nature", "perception", "survival"], hitDie: 8, features: ["Druidic", "Spellcasting"], armorProficiencies: ["Light Armor", "Medium Armor", "Shields"], weaponProficiencies: ["Clubs", "Daggers", "Darts", "Javelins", "Maces", "Quarterstaffs", "Scimitars", "Sickles", "Slings", "Spears"], toolProficiencies: ["Herbalism Kit"], languages: ["Druidic"], spellcastingAbility: "wis", spellcastingKind: "prepared", cantripsKnownByLevel: { 1: 2 }, startingEquipment: equipmentChoices("druid", [{ label: "Choose protection or a weapon", choose: 1, options: ["wooden-shield", "simple-weapon"] }, { label: "Choose a weapon", choose: 1, options: ["quarterstaff", "simple-weapon"] }, { label: "Choose a pack", choose: 1, options: ["explorers-pack", "scholars-pack"] }]), description: "A nature-focused spellcaster connected to beasts, terrain, and primal magic.", source: srdRulesSource },
...
export const srdSpells: SrdSpell[] = [
  ...
  { id: "eldritch-blast", name: "Eldritch Blast", level: 0, school: "Evocation", classes: ["Warlock"], castingTime: "1 action", range: "120 feet", components: ["V", "S"], materialDetails: "", duration: "Instantaneous", concentration: false, ritual: false, damageType: "Force", damageFormula: "1d10", attackRollRequired: true, higherLevelScaling: "Creates more beams at higher character levels.", description: "Make a ranged spell attack with crackling energy. On a hit, the target takes force damage.", source: srdRulesSource },
  { id: "entangle", name: "Entangle", level: 1, school: "Conjuration", classes: ["Druid"], castingTime: "1 action", range: "90 feet", components: ["V", "S"], materialDetails: "", duration: "Concentration, up to 1 minute", concentration: true, ritual: false, areaOfEffectType: "Square", areaOfEffectSize: "20-foot square", savingThrowType: "STR", statusEffects: "Restrained", description: "Plants erupt in an area, creating difficult terrain and potentially restraining creatures that fail a Strength saving throw.", source: srdRulesSource },
  { id: "faerie-fire", name: "Faerie Fire", level: 1, school: "Evocation", classes: ["Bard", "Druid"], castingTime: "1 action", range: "60 feet", components: ["V"], materialDetails: "", duration: "Concentration, up to 1 minute", concentration: true, ritual: false, areaOfEffectType: "Cube", areaOfEffectSize: "20-foot cube", savingThrowType: "DEX", statusEffects: "Outlined; attacks can gain advantage", description: "Outline creatures and objects in light. Attacks against affected targets can gain advantage if they fail a Dexterity saving throw.", source: srdRulesSource },
  { id: "fire-bolt", name: "Fire Bolt", level: 0, school: "Evocation", classes: ["Sorcerer", "Wizard"], castingTime: "1 action", range: "120 feet", components: ["V", "S"], materialDetails: "", duration: "Instantaneous", concentration: false, ritual: false, damageType: "Fire", damageFormula: "1d10", attackRollRequired: true, higherLevelScaling: "Damage increases at higher character levels.", description: "Make a ranged spell attack with fire. On a hit, the target takes fire damage.", source: srdRulesSource },
  { id: "guidance", name: "Guidance", level: 0, school: "Divination", classes: ["Cleric", "Druid"], castingTime: "1 action", range: "Touch", components: ["V", "S"], materialDetails: "", duration: "Concentration, up to 1 minute", concentration: true, ritual: false, statusEffects: "Adds 1d4 to one ability check", description: "Touch a willing creature to help one ability check before the spell ends.", source: srdRulesSource },
  { id: "healing-word", name: "Healing Word", level: 1, school: "Abjuration", classes: ["Bard", "Cleric", "Druid"], castingTime: "1 bonus action", range: "60 feet", components: ["V"], materialDetails: "", duration: "Instantaneous", concentration: false, ritual: false, healingFormula: "2d4", higherLevelScaling: "Add your spellcasting modifier. Healing increases when cast with a higher-level spell slot.", description: "A creature you can see regains hit points from a brief word of healing.", source: srdRulesSource },
  ...
  { id: "magic-missile", name: "Magic Missile", level: 1, school: "Evocation", classes: ["Sorcerer", "Wizard"], castingTime: "1 action", range: "120 feet", components: ["V", "S"], materialDetails: "", duration: "Instantaneous", concentration: false, ritual: false, damageType: "Force", damageFormula: "3d4+3", higherLevelScaling: "Creates one additional dart for each slot level above 1.", description: "Create darts of magical force that strike creatures you can see.", source: srdRulesSource },
  { id: "produce-flame", name: "Produce Flame", level: 0, school: "Conjuration", classes: ["Druid"], castingTime: "1 action", range: "Self", components: ["V", "S"], materialDetails: "", duration: "10 minutes", concentration: false, ritual: false, damageType: "Fire", damageFormula: "1d8", attackRollRequired: true, higherLevelScaling: "Damage increases at higher character levels.", description: "Create flame in your hand for light or hurl it as a ranged spell attack.", source: srdRulesSource },
  { id: "sacred-flame", name: "Sacred Flame", level: 0, school: "Evocation", classes: ["Cleric"], castingTime: "1 action", range: "60 feet", components: ["V", "S"], materialDetails: "", duration: "Instantaneous", concentration: false, ritual: false, damageType: "Radiant", damageFormula: "1d8", savingThrowType: "DEX", higherLevelScaling: "Damage increases at higher character levels.", description: "Radiance descends on a creature. The target makes a Dexterity saving throw or takes radiant damage.", source: srdRulesSource },
  { id: "shillelagh", name: "Shillelagh", level: 0, school: "Transmutation", classes: ["Druid"], castingTime: "1 bonus action", range: "Touch", components: ["V", "S", "M"], materialDetails: "Mistletoe.", duration: "1 minute", concentration: false, ritual: false, damageFormula: "1d8", statusEffects: "Empowered club or quarterstaff", description: "Empower a club or quarterstaff so it can use your spellcasting ability for attacks and damage.", source: srdRulesSource },
  ...
  { id: "thunderwave", name: "Thunderwave", level: 1, school: "Evocation", classes: ["Bard", "Druid", "Sorcerer", "Wizard"], castingTime: "1 action", range: "Self", components: ["V", "S"], materialDetails: "", duration: "Instantaneous", concentration: false, ritual: false, damageType: "Thunder", damageFormula: "2d8", areaOfEffectType: "Cube", areaOfEffectSize: "15-foot cube", savingThrowType: "CON", statusEffects: "Pushes creatures on a failed save", higherLevelScaling: "Damage increases when cast with a higher-level spell slot.", description: "A wave of thunderous force pushes creatures away from you and deals thunder damage on a failed Constitution saving throw.", source: srdRulesSource },
];
